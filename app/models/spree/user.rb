module Spree
  class User < ActiveRecord::Base
    ...
    has_many :orders
    has_many :custom_signs, :foreign_key => 'spree_user_id'
    has_many :user_notes, :foreign_key => 'spree_user_id', :class_name => 'UserNotes'
    has_many :saved_signs, :foreign_key => 'user_id', :class_name => 'SavedSign'
    ...
    attr_accessible :email, :password, :password_confirmation, :remember_me, :persistence_token, :login, :role_ids, :mailing_list, :bill_address_attributes, :ship_address_attributes
